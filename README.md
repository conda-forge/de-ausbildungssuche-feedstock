About de-ausbildungssuche-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-ausbildungssuche-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-ausbildungssuche-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-ausbildungssuche
# for installing globally
pixi global install de-ausbildungssuche
```
...
It is possible to list all of the versions of `de-ausbildungssuche` available on your platform:
...
```
pixi search de-ausbildungssuche --channel conda-forge
```
